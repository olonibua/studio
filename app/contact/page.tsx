                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-text-muted">hello@mvpstudio.com</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-6 bg-background-primary rounded-lg border border-neutral-800">
              ...
              <h3 className="font-semibold text-text-primary mb-2">Twitter</h3>
              <p className="text-text-muted text-sm mb-3">Follow us for updates and tips</p>
              <a href="#" className="text-blue-400 hover:text-blue-300 text-sm">@MVPStudio</a>
            </div>
            ...
            <div className="text-center p-6 bg-background-primary rounded-lg border border-neutral-800">
              ...
              <a href="#" className="text-green-400 hover:text-green-300 text-sm">+1 (555) 123-4567</a>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="aspect-video bg-background-secondary rounded-lg flex items-center justify-center border border-neutral-800 max-w-4xl mx-auto">
            <div className="text-center text-text-muted">
              ...
              <p className="italic text-sm px-6">
                Insert interactive map: Google Maps showing San Francisco location with office pin
              </p>
            </div>
          </div>
        </div>
